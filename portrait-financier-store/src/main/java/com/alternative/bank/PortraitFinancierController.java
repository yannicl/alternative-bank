...
public class PortraitFinancierController {
    ...
    @RequestMapping(value = "usagers/{usagerId}/detention", method = {RequestMethod.GET})
    public ResponseEntity<Resources<ProduitDetenuResource>> getDetention(@PathVariable("usagerId") long usagerId) {
    ...
    @RequestMapping(value = "produits/{produitDetenuId}/transactions", method = {RequestMethod.GET})
